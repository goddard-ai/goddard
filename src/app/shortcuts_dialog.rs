...
fn shortcut_rows() -> Vec<(&'static str, Vec<ShortcutRow>)> {
    ...
    vec![
        ...
        (
            ...
            vec![
                bound(tr!("shortcuts.navigate_back"), NavigateBack, Some("Waku")),
                bound(
                ...
                bound(tr!("shortcuts.find"), OpenFind, Some("Waku")),
        ...
        (
            ...
            vec![
                ...
                bound(tr!("shortcuts.dismiss"), DismissMenu, Some("WakuMenu")),
                bound(
                    tr!("shortcuts.select_next"),
                    SelectNextEntry,
