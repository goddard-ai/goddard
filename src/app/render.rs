...
impl Render for Waku {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let content = div()
            ...
            // unclaimed keystroke from a focused descendant — or from
            // nothing, on platforms where this div is the dispatch root —
            // either sends the draft (or fires the stopped-turn Continue) or
...
impl Waku {
    ...
    fn render_toast(
        ...
        let status_icon = match tone {
            ...
            ToastTone::Failure => icon("icons/x-bold.svg", 14.0, theme.danger).into_any_element(),
