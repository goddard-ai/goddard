...
pub static COMMANDS: &[CommandDescriptor] = &[
    ...
    CommandDescriptor { id: "model.cycle_effort", action: || Box::new(crate::CycleReasoningEffort), title_key: "keybind.command.cycle_effort", title_index: None, category: C::Workspace, editability: EDITABLE, builtin_label: None },
...
pub static ENTRIES: &[CatalogEntry] = &[
    ...
    e("switcher.project_backward", All, "secondary-shift-n", ProjectSwitcher),
    e("switcher.project_backward", All, "secondary-shift-n", BigPicture),
