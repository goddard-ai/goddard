...
pub static COMMANDS: &[CommandDescriptor] = &[
    ...
    CommandDescriptor { id: "workspace.latest_unseen", action: || Box::new(crate::GoToNextUnreadCompletion), title_key: "shortcuts.latest_unseen", title_index: None, category: C::Workspace, editability: EDITABLE, builtin_label: None },
    ...
    CommandDescriptor { id: "workspace.mark_unread_next", action: || Box::new(crate::MarkUnreadAndGoToNextIdle), title_key: "shortcuts.mark_unread_next", title_index: None, category: C::Workspace, editability: EDITABLE, builtin_label: None },
    ...
    CommandDescriptor { id: "automations.tab.1", action: || Box::new(crate::SelectAutomationsTab { index: 0 }), title_key: "keybind.command.automations_tab", title_index: Some(0), category: C::Other, editability: EDITABLE, builtin_label: None },
    CommandDescriptor { id: "automations.tab.2", action: || Box::new(crate::SelectAutomationsTab { index: 1 }), title_key: "keybind.command.automations_tab", title_index: Some(1), category: C::Other, editability: EDITABLE, builtin_label: None },
    ...
    CommandDescriptor { id: "model.cycle_favorite", action: || Box::new(crate::CycleFavoriteModel), title_key: "keybind.command.cycle_favorite", title_index: None, category: C::Workspace, editability: EDITABLE, builtin_label: None },
