...
export const SETTINGS_PAGES: Array<{
  ...
  { id: 'providers', label: 'Providers', labelKey: 'settings.providers', icon: 'bot', keywords: 'providers agents models cli version install detect claude codex cursor opencode opencode2 amp grok pi omp oh my pi kimi fx deepseek devin', keywordsKey: 'settings.providers_keywords' },
