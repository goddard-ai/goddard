...
export const GODDARD_ICONS = {
  ...
  info: 'i-waku-info',
  keyRound: 'i-waku-key-round',
  languages: 'i-waku-languages',
...
export type WakuIconName = keyof typeof GODDARD_ICONS
...
const PROVIDER_ICONS: Record<ProviderKind, string> = {
  ...
  copilot: 'i-waku-provider-copilot',
  cursor: 'i-waku-provider-cursor',
  deepSeek: 'i-waku-provider-deepseek',
  devin: 'i-waku-provider-devin',
  droid: 'i-waku-provider-droid',
...
export const PROVIDERS: Array<{
  ...
  { id: 'copilot', name: 'GitHub Copilot', shortName: 'Copilot', command: 'copilot' },
  ...
  { id: 'devin', name: 'Devin CLI', shortName: 'Devin', command: 'devin' },
  { id: 'droid', name: 'Droid', shortName: 'Droid', command: 'droid' },
