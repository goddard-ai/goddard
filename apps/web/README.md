...
Browser client for an existing Goddard daemon. The Cloudflare Worker serves the
...
Goddard Desktop can expose the daemon it manages from Settings → Daemon, where you
