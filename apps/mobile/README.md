...
Expo client for connecting to one or more remote Goddard daemons from iOS,
Android.
...
In Goddard Desktop, enable the remote daemon and copy its WebSocket address and
...
Goddard is licensed under the repository's GNU GPL v3.0-only license.
