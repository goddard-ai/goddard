          ...
          <>
            ...
            {busy && (
              <Pressable
                ...
                style={({ pressed }) => [
                  styles.sendButton,
                  { backgroundColor: theme.inverse, opacity: pressed ? 0.55 : 1 },
                ]}>
                <AppSymbol
...
const styles = StyleSheet.create({
  ...
  errorText: { flex: 1, fontSize: 13, fontWeight: '600', lineHeight: 17 },
  queuedRow: {
    alignItems: 'center',
    borderRadius: Radius.small,
    borderWidth: StyleSheet.hairlineWidth,
  ...
  queuedText: { flex: 1, fontSize: 13.5 },
  requestPanel: {
  ...
  requestTitle: { flex: 1, fontSize: 15, fontWeight: '700' },
  detailScroll: {
    borderRadius: Radius.small,
    borderWidth: StyleSheet.hairlineWidth,
    marginTop: 9,
  ...
  requestDetail: { fontFamily: MonoFont, fontSize: 12.5, lineHeight: 17 },
  ...
  optionButtonText: { fontSize: 14, fontWeight: '700' },
  panelError: { fontSize: 13, lineHeight: 17, marginTop: 8 },
  questionHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' },
  questionEyebrow: { fontSize: 12, fontWeight: '700', letterSpacing: 0.55, textTransform: 'uppercase' },
  progress: { fontSize: 12, fontWeight: '600' },
  questionText: { fontSize: 15, fontWeight: '600', lineHeight: 20, marginTop: 7 },
  ...
  questionOptionLabel: { fontSize: 14, fontWeight: '600' },
  questionOptionDescription: { fontSize: 12.5, lineHeight: 16, marginTop: 2 },
  customAnswer: {
    borderRadius: Radius.medium,
    borderWidth: 1,
    fontSize: 14,
