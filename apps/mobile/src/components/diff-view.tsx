...
const styles = StyleSheet.create({
  ...
  marker: { fontFamily: MonoFont, fontSize: 12, lineHeight: 16.5, width: 12 },
  line: { fontFamily: MonoFont, fontSize: 12, lineHeight: 16.5 },
  hunk: { fontFamily: MonoFont, fontSize: 11.5, lineHeight: 18, marginVertical: 2 },
  truncated: { fontSize: 11.5, marginTop: 4 },
