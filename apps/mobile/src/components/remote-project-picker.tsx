...
export function RemoteProjectPicker({
  ...
  const directory = useQuery({
    ...
    queryFn: () => {
      if (!daemon.client) throw new Error('Goddard daemon is disconnected');
...
const styles = StyleSheet.create({
  ...
  pathInput: { flex: 1, fontSize: 15, minHeight: 44, paddingHorizontal: 9, paddingVertical: 8 },
  ...
  locationText: { fontSize: 12.5, fontWeight: '600' },
  error: { borderRadius: Radius.medium, marginHorizontal: Spacing.three, marginTop: 11, padding: 10 },
  errorText: { fontSize: 13.5, fontWeight: '600', lineHeight: 17 },
  ...
  folderName: { flex: 1, fontSize: 15.5, fontWeight: '600' },
  ...
  emptyWorkspaceText: { fontSize: 13.5, fontWeight: '600' },
  footerPath: { flex: 1, fontSize: 11.5, textAlign: 'right' },
});
