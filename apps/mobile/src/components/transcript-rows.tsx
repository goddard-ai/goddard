...
const styles = StyleSheet.create({
  ...
  foldLabel: { flexShrink: 1, fontSize: 13, fontWeight: '500' },
  changedCard: {
  ...
  changedTitle: { flex: 1, fontSize: 13.5, fontWeight: '600' },
  changedStats: { fontSize: 12.5, fontVariant: ['tabular-nums'], fontWeight: '600' },
  changedFiles: {
  ...
  changedFilePath: { flex: 1, fontFamily: MonoFont, fontSize: 12 },
  workingStrip: {
    alignItems: 'center',
    flexDirection: 'row',
    gap: 8,
  ...
  workingText: { fontSize: 13.5, fontWeight: '500' },
  workingElapsed: { fontSize: 13, fontVariant: ['tabular-nums'] },
  empty: { alignItems: 'center', paddingHorizontal: 32 },
  emptyTitle: { fontSize: 18, fontWeight: '700', textAlign: 'center' },
  emptyBody: { fontSize: 14.5, lineHeight: 19, marginTop: 8, textAlign: 'center' },
});
