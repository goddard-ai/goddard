...
The desktop app consumes shared platform data and routes privileged behavior through trusted host boundaries. It is the primary human workspace, not a separate source of platform truth.
