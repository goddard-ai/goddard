...
export const shortcutKeymapProfiles = {
  goddard: {
    ...
    label: "Goddard",
    bindings: {
      "navigation.openInbox": ["Alt+Digit1"],
      "navigation.openSessions": ["Alt+Digit2"],
      "navigation.openSearch": ["Alt+Digit3"],
      "navigation.openSpecs": ["Alt+Digit4"],
      "navigation.openTasks": ["Alt+Digit5"],
      "navigation.openRoadmap": ["Alt+Digit6"],
      ...
      "inbox.selectUnreadFilter": ["Mod+Digit1"],
      "inbox.selectSavedFilter": ["Mod+Digit2"],
      ...
      "workbench.navigateBack": ["Mod+Alt+ArrowLeft"],
      "workbench.navigateForward": ["Mod+Alt+ArrowRight"],
    },
  },
