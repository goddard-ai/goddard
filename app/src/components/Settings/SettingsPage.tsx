  ...
  return (
    <div class={pageClass}>
      <section class={cardClass}>
        <div class={badgeClass}>Placeholder</div>
        <h1 class={titleClass}>Settings</h1>
        <p class={bodyClass}>
          This tab is a placeholder for the future settings and preferences surface.
        </p>
        <p class={bodyClass}>
          The top-bar settings button now opens a normal detail tab so the real implementation can
          land without changing the shell interaction again.
        </p>
      </section>
    </div>
  )
