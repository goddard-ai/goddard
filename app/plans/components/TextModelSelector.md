...
- **Likely Fit:** Deferred alongside future configuration editing inside the existing settings page; reusable later in any config-editing surface that needs one text-model picker.
