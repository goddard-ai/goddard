...
- **Side Effects:** Uses SDK-backed daemon auth flows; persists the auth session to host storage; coordinates with `DaemonActivityCoordinator` if a shared authenticated event stream is introduced.
