...
- **Data Shape:** Map keyed by `DaemonPullRequestId` containing the daemon PR record, optional discussion summary, optional full timeline, related session ids, load and refresh status, and last merged event timestamp.
