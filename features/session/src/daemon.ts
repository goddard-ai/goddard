...
type SessionExtension = {
  ...
  releaseLaunchLease: SessionManager["releaseLaunchLease"]
  ...
  setConfigOption: SessionManager["setSessionConfigOption"]
  setModel: SessionManager["setSessionModel"]
...
export const sessionPlugin = definePlugin({
  ...
  setup(context) {
    ...
    const session = {
      ...
      releaseLaunchLease: (params) => getSessionManager().releaseLaunchLease(params),
      ...
      setConfigOption: (params) => getSessionManager().setSessionConfigOption(params),
      setModel: (params) => getSessionManager().setSessionModel(params),
    ...
    return {
      ...
      ipcHandlers: {
        session: {
          ...
          launchLease: {
            release: async ({ body }) => session.releaseLaunchLease(body),
          },
          ...
          configOption: {
            set: async ({ body }) => ({
              session: await session.setConfigOption(body),
            }),
          },
          model: {
            set: async ({ body }) => ({
              session: await session.setModel(body),
            }),
          },
