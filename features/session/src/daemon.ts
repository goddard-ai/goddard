    ...
    return {
      provides: {
        session: {
          ...
          unarchiveSession: sessionManager.unarchiveSession,
      ...
      ipcHandlers: {
        session: {
          ...
          archive: async ({ body: { id } }) => sessionManager.archiveSession(id),
          unarchive: async ({ body: { id } }) => sessionManager.unarchiveSession(id),
