...
This is the critical path for Goddard parity.
...
## Why Goddard's previous approximation failed
...
## Compatibility requirements for Goddard
...
1. Codex/Goddard remains the actual frontmost application throughout.
