...
- Run `pnpm run check:docs` after editing public docs; it checks page shape, opening blockquotes, local links, directory README files, and hard-banned internal markers.
