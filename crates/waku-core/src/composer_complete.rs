...
fn assemble_slash_commands(
    ...
    match provider {
        ...
        // Copilot reads project skills from `.github/skills` and `.claude/skills`,
        // and personal skills from `~/.copilot/skills`. The shared
        // `.agents/skills` layer below covers its third documented root.
