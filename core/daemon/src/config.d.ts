...
export declare function resolveDaemonRuntimeConfig(input?: DaemonRuntimeConfigInput): ResolvedDaemonRuntimeConfig;
export declare function prependAgentBinToPath(agentBinDir: string, env?: Record<string, string>): Record<string, string>;
