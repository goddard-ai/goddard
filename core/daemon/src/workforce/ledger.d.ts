...
export declare function summarizeWorkforceProjection(
...
export declare function buildWorkforceQueues(
  requests: Record<string, WorkforceRequestRecord>,
): Record<string, string[]>
export declare function applyWorkforceEvent(
  requests: Record<string, WorkforceRequestRecord>,
...
export declare function appendWorkforceLedgerEvent(
  rootDir: string,
  event: WorkforceLedgerEvent,
): Promise<void>
