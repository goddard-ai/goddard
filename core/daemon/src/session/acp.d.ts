...
export declare function isAcpRequest<T extends AnyRequest>(
  message: {
    jsonrpc?: string
  },
  method: string,
...
export declare function createAgentConnection(
  stdin: Writable,
  stdout: Readable,
...
export declare function createAgentMessageStream(
  stdin: Writable,
  stdout: Readable,
  hooks?: AgentStreamHooks,
): acp.Stream
