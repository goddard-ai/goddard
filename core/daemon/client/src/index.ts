...
export type DaemonIpcClientFactoryInput = DaemonConnection
...
export { createDaemonUrl, createTcpDaemonUrl, readDaemonConnectionFromDaemonUrl, readSocketPathFromDaemonUrl }
...
export function createDaemonIpcClient<TClient = DaemonIpcClient>(options: {
  ...
  return options.createClient(readDaemonConnectionFromDaemonUrl(options.daemonUrl))
}
